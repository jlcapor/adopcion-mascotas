		...
		>
			{showText && (
				...
				>
					...
					>
						Registra tu refugio en unos pocos pasos y comienza a agregar mascotas
					</motion.p>
					<motion.div
						className="pt-4"
						variants={{
					...
					>
						<Button size="lg" onClick={() => router.push('/onboarding?step=create-shelter')}>Empezar</Button>
					</motion.div>
				</motion.div>
			)}
		</motion.div>
